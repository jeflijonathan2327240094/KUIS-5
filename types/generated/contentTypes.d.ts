...
export interface ApiTransactionTransaction extends Schema.CollectionType {
  ...
  attributes: {
    inscurance_price: Attribute.Integer;
    shipping_price: Attribute.Integer;
    total_price: Attribute.Integer;
    code: Attribute.String;
    transaction_status: Attribute.Enumeration<
...
export interface ApiTransactionsDetailTransactionsDetail
  extends Schema.CollectionType {
  ...
  attributes: {
    price: Attribute.BigInteger;
    shipping_status: Attribute.Enumeration<['PENDING', 'SHIPPING', 'SUCCESS']>;
    resi: Attribute.String;
    code: Attribute.String;
    transaction: Attribute.Relation<
      'api::transactions-detail.transactions-detail',
      'oneToOne',
      'api::transaction.transaction'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::transactions-detail.transactions-detail': ApiTransactionsDetailTransactionsDetail;
    }
  }
}
